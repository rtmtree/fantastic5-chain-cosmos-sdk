...
const baseMwInfo: object = { nextId: 0 };

export const MwInfo = {
  encode(message: MwInfo, writer: Writer = Writer.create()): Writer {
    if (message.nextId !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): MwInfo {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMwInfo } as MwInfo;
  ...
  toJSON(message: MwInfo): unknown {
    const obj: any = {};
    message.nextId !== undefined && (obj.nextId = message.nextId);
    return obj;
  },

  fromPartial(object: DeepPartial<MwInfo>): MwInfo {
    const message = { ...baseMwInfo } as MwInfo;
    if (object.nextId !== undefined && object.nextId !== null) {
